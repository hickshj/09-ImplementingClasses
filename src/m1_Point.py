...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.y = y
        self.n = self.n + 1
        self.d = self.d + self.get_distance_from(Point(self.px, self.py))
        self.px = self.x
        self.py = self.y
    ...
    def get_distance_from_start(self):
        return self.get_distance_from(Point(self.px, self.py))

    def get_distance_travelled(self):
        return self.d

    def closer_to(self, p2, p3):
        self.q = self.get_distance_from(p2)
        self.q1 = self.get_distance_from(p3)
        if self.q <= self.q1:
            return p2
        else:
            return p3
